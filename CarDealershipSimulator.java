...
public class CarDealershipSimulator {
    public static void main(String[] args) {
        ...
        while (!command.equals("Q")) {
            ...
            {
                Scanner check = new Scanner (commandLine[1] + commandLine[2]);
                if(check.hasNextInt()) 
                {
                    double maxPrice = check.nextInt();
                    double minPrice = check.nextInt();
                ...
                {
                    System.out.println("Invalid input for the price command.");
                }
                check.close();
    ...
    /**
     * This static method takes in a file name, constructs a file from it. It then reads details
     * of cars provided in input file, creates Car objects and adds the latter to an array.
     * The arraylist of cars is then returned.
     * @param filename the name of the input file, i.e file containing cars and their details
     * @return an array of Car objects
     * @throws FileNotFoundException thrown when a file matching input is not found
     * @throws InputMismatchException when the car details have incorrect type
     */
